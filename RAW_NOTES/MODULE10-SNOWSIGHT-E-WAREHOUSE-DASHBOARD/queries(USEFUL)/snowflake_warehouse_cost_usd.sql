...
AND WAREHOUSE_NAME=:my_warehouse -- custom filter (created by us) example. (dynamic, use SNOWSIGHT to insert value) -- and ':Warehouse' is a custom filter, created by us
